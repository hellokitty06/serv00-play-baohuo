...
## 2024/12/26/09:00 更新serv00-ql和serv00-vps  修复TG推送通知的BUG TG不支持 **\n** 换成 **%0A** 换行符号
...
| 配置项                 | 值                                                                 | 说明                                      |
|------------------------|--------------------------------------------------------------------|-------------------------------------------|
| `NOTIFICATION`          | 3                                                                  | 当 NOTIFICATION = 0 时 不发通知 。当 NOTIFICATION = 1 时，意味着只启用 Telegram 作为通知服务。若 NOTIFICATION = 2，则表示仅启用 WxPusher 通知服务。对于 NOTIFICATION = 3 的情况， PushPlus 作为通知服务当 NOTIFICATION = 4，它代表同时启用 Telegram 和 WxPusher 两种通知服务。当 NOTIFICATION = 5 时，它代表同时启用 Telegram 和 PushPlus 两种通知服务 |
